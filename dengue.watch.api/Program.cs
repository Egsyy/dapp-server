...
builder.Services.AddCors(options =>
{
    ...
    options.AddPolicy("DefinedOrigins", policy =>
    {
        ...
        policy.WithOrigins("http://localhost:3000", "http://localhost:5000", "https://dengue-app-eight.vercel.app", "https://dengue-app-git-main-eggsys-projects-bc092aa9.vercel.app")
            .AllowAnyMethod()
            .AllowAnyHeader()
            .AllowCredentials();
    });
