...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("dengue.watch.api.infrastructure.database.CommunityPreventiveAdvisory", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid")
                        .HasColumnName("id");
                    ...
                    b.HasKey("Id")
                        .HasName("PK_community_preventive_advisories");

                    b.ToTable("community_preventive_advisories", (string)null);
                });
            ...
            modelBuilder.Entity("dengue.watch.api.infrastructure.database.PredictedWeeklyDengueCase", b =>
                {
                    ...
                    b.ToTable("predicted_weekly_dengue_cases", (string)null);
                });
            ...
            modelBuilder.Entity("dengue.watch.api.infrastructure.database.PredictedWeeklyDengueCase", b =>
                {
                    b.HasOne("dengue.watch.api.infrastructure.database.AdministrativeArea", "AdministrativeArea")
                        .WithMany("PredictedWeeklyDengueCases")
                        .HasForeignKey("PsgcCode")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
            ...
            modelBuilder.Entity("dengue.watch.api.infrastructure.database.AdministrativeArea", b =>
                {
                    ...
                    b.Navigation("PredictedWeeklyDengueCases");
